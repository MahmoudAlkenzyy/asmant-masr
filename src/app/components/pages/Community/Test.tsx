...
//         const res = await fetch("https://cement.northeurope.cloudapp.azure.com:4433/api/News/CreateNews", {
//           method: "POST",
//           headers: {
...
export default function CreateProducerForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://cement.northeurope.cloudapp.azure.com:4433/api/Producer/CreateProducer", {
        method: "POST",
        headers: {
          Authorization:
